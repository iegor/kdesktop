...
//     if(type() == "pop") {
//         parent = static_cast<KMFolderMailDir*>(aMsg->storage());
//     }

//  if(!parent) {
//    perror("Critical error: parent is empty");
//    KMessageBox::information(0,(i18n("Critical error: "
//      "parent is empty: ")) + QString::fromLocal8Bit(strerror(errno)));
//    return false;
//  }
...
*/
  ...
  if ( processResult == 1 ) {
    ...
    if(!aMsg->parent()) {
        perror("Critical error: parent is empty");
        KMessageBox::information(0,(i18n("Critical error: parent is empty: ")) +
